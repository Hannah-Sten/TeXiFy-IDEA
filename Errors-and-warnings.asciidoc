...
----
This database file appears more than once: references34.bib
---line 3 of file bibtex-mwe.aux
 : \bibdata{references34
 :                      }
I'm skipping whatever remains of this command
...
aux_err_print/aux_err_return format:
...
=== Illegal, another \bib data command
=== Illegal, another \bib style command
