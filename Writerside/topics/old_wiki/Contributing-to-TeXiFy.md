...
We assume that git, IntelliJ, java and LaTeX are installed. If not, try the normal [installation instructions](https://github.com/Hannah-Sten/TeXiFy-IDEA/wiki/Installation) first.
...
* If something doesn’t work, try looking at the [FAQ](https://github.com/Hannah-Sten/TeXiFy-IDEA/wiki/Troubleshooting) first.
