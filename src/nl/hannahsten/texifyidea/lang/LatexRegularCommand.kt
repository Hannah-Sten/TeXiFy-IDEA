...
enum class LatexRegularCommand(
    ...
    AGEMO("agemO", dependency = WASYSYM, display = "℧"),
    APLBOX("APLbox", dependency = WASYSYM, display = "⎕"),
    APLCIRC("APLcirc", dependency = WASYSYM,),
    APLCOMMENT("APLcomment", dependency = WASYSYM),
    APLDOWN("APLdown", dependency = WASYSYM, display = "⍗"),
    APLDOWNARROWBOX("APLdownarrowbox", dependency = WASYSYM),
    APLINV("APLinv", dependency = WASYSYM, display = "⌹"),
    APLINPUT("APLinput", dependency = WASYSYM, display = "⍞"),
    APLLEFTARROWBOX("APLleftarrowbox", dependency = WASYSYM, display = "⍇"),
    APLLOG("APLlog", dependency = WASYSYM, display = "⍟"),
    APLMINUS("APLminus", dependency = WASYSYM, display = "—"),
    APLNOT("APLnot", dependency = WASYSYM, display = "∼"),
    APLRIGHTARROWBOX("APLrightarrowbox", dependency = WASYSYM, display = "⍈"),
    APLSTAR("APLstar", dependency = WASYSYM, display = "\uD83D\uDFAF"),
    APLUP("APLup", dependency = WASYSYM),
    APLUPARROWBOX("APLuparrowbox", dependency = WASYSYM, display = "⍐"),
    APLVERT("APLvert", dependency = WASYSYM, display = "|"),
    ...
    ASCNODE("ascnode", dependency = WASYSYM, display = "☊"),
    ...
    BOWTIE("Bowtie", dependency = WASYSYM, display = "⋈"),
    BROKENVERT("brokenvert", dependency = WASYSYM, display = "¦"),
    CANCER("cancer", dependency = WASYSYM, display = "♋"),
    CAPITAL_CIRCLE("Circle", dependency = WASYSYM, display = "○"),
    ...
    CONJUGATION("conjunction", dependency = WASYSYM, display = "☌"),
    CROSSED_BOX("XBox", dependency = WASYSYM, display = "☒"),
    CURRENCY("currency", dependency = WASYSYM, display = "¤"),
    DAVIDSSTAR("davidsstar", dependency = WASYSYM, display = "✡"),
    DESCNODE("descnode", dependency = WASYSYM, display = "☋"),
    DIAMETER("diameter", dependency = WASYSYM, display = "⌀"),
    DOWN_ARROW("DOWNarrow", dependency = WASYSYM, display = "▼"),
    EARTH("earth", dependency = WASYSYM, display = "♁"),
    EIGHTNOTE("eighthnote", dependency = WASYSYM, display = "♪"),
    FEMALE("female", dependency = WASYSYM, display = "♀"),
    FROWNIE("frownie", dependency = WASYSYM, display = "☹"),
    FULLMOON("fullmoon", dependency = WASYSYM, display = "○"),
    FULLNOTE("fullnote", dependency = WASYSYM, display = "\uD834\uDD5D"),
    GEMINI("gemini", dependency = WASYSYM, display = "♊"),
    GLUON("gluon", dependency = WASYSYM),
    HALFNOTE("halfnote", dependency = WASYSYM, display = "\uD834\uDD5E"),
    HEXAGON("hexagon", dependency = WASYSYM),
    HEXSTAR("hexstar", dependency = WASYSYM),
    HF("HF", dependency = WASYSYM, display = "∼"),
    INVDIAMETER("invdiameter", dependency = WASYSYM),
    INVE("inve", dependency = WASYSYM, display = "Ə"),
    JUPITER("jupiter", dependency = WASYSYM, display = "♃"),
    KREUZ("kreuz", dependency = WASYSYM, display = "✠"),
    LEFTMOON("leftmoon", dependency = WASYSYM, display = "☾"),
    LEFTTURN("leftturn", dependency = WASYSYM, display = "↺"),
    LEFT_CIRCLE("Leftcircle", dependency = WASYSYM),
    ...
    LIGHTNING("lightning", dependency = WASYSYM, display = "☇"),
    ...
    NEWMOON("newmoon", dependency = WASYSYM, display = "◯"),
    NOTBACKSLASH("notbackslash", dependency = WASYSYM),
    NOTSLASH("notslash", dependency = WASYSYM),
    ...
    QUARTERNOTE("quarternote", dependency = WASYSYM, display = ""),
    RECORDER("recorder", dependency = WASYSYM, display = "♩"),
    RIGHTMOON("rightmoon", dependency = WASYSYM, display = "☽"),
    RIGHTTURN("rightturn", dependency = WASYSYM, display = "↻"),
    RIGHT_CIRCLE("Rightcircle", dependency = WASYSYM),
    ...
    UP_ARROW("UParrow", dependency = WASYSYM, display = "▲"),
    URANUS("uranus", dependency = WASYSYM, display = "⛢"),
    VARANGLE("varangle", dependency = WASYSYM, display = "∡"),
    VARHEXAGON("varhexagon", dependency = WASYSYM, display = "⬡"),
    VARHEXSTAR("varhexstar", dependency = WASYSYM, display = "\uD83D\uDFB5"),
    ...
    WASYLOZENGE("wasylozenge", dependency = WASYSYM, display = "⯏"),
