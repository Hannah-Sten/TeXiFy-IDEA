...
* link:Running/Run-configurations[One run configuration per fileset]
...
* link:Running/SumatraPDF-support#Portable-SumatraPDF[(Windows) Choose a custom path to SumatraPDF]
