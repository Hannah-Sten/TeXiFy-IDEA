...
class RunMakeindexListener(
            ...
            if (makeindexRunConfig.makeindexProgram == MakeindexProgram.BIB2GLS) {
                try {
                    ...
                    if (mainFile != null && auxilDir != null && mainFile.path != auxilDir.path) {
                        FileUtil.rename(File(mainFile.parent.path + '/' + baseFileName.appendExtension("glstex")), File(auxilDir.path + '/' + baseFileName.appendExtension("glstex")))
                    }
                }
    ...
    private fun generateIndexConfig(): RunnerAndConfigurationSettings {
        ...
        runConfig.setDefaultMakeindexProgram()
