...
* On typing `\begin{environment}` + kbd:[Enter], automatic insertion of `\end{environment}` with correct indentation
* On typing `\[` + kbd:[Enter], automatic insertion of `\]` with correct indentation
* Automatic insertion of braces of first required parameter
* Typing `}` at closing brace skips over it
