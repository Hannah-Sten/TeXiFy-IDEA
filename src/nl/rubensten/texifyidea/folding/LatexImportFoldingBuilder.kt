...
open class LatexImportFoldingBuilder : FoldingBuilderEx() {
    ...
    override fun buildFoldRegions(root: PsiElement, document: Document, quick: Boolean): Array<FoldingDescriptor> {
        ...
        val commands = LatexCommandsIndex.getCommandsByName("usepackage", root.containingFile) +
                LatexCommandsIndex.getCommandsByName("RequirePackage", root.containingFile)
