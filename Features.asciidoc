...
* Inclusion loops
* Nested includes
* link:Probable-bugs#Label-before-caption[Label is before caption]
...
* link:Writing-organisation-recommendations#verbatim[Verbatim environments might break TeXiFy]
