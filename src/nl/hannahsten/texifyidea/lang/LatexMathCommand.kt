...
enum class LatexMathCommand(
    ...
    VAR_CAPITAL_GAMMA("varGamma", dependency = AMSMATH, collapse = true),
    DELTA("delta", display = "δ", collapse = true),
    CAPITAL_DELTA("Delta", display = "Δ", collapse = true),
    VAR_CAPITAL_DELTA("varDelta", dependency = AMSMATH, collapse = true),
    ...
    VAR_CAPITAL_THETA("varTheta", dependency = AMSMATH, collapse = true),
    ...
    VAR_CAPITAL_LAMBDA("varLambda", dependency = AMSMATH, collapse = true),
    ...
    VAR_CAPITAL_XI("varXi", dependency = AMSMATH, collapse = true),
    PI("pi", display = "π", collapse = true),
    PI_SYMBOL("varpi", display = "ϖ", collapse = true),
    CAPITAL_PI("Pi", display = "Π", collapse = true),
    VAR_CAPITAL_PI("varPi", dependency = AMSMATH, collapse = true),
    ...
    LEFT_GROUP("lgroup"),
    RIGHT_GROUP("rgroup"),
    LEFT_VERT("lvert", dependency = AMSMATH),
