...
//        runConfig.getConfigOptions().hasBeenRun = true
//
...
//        else if (runConfig.pdfViewer == InternalPdfViewer.SUMATRA && (runConfig.sumatraPath != null || isSumatraAvailable) && runConfig.getConfigOptions().outputFormat == LatexCompiler.OutputFormat.PDF) {
