This is a list of most of the errors and warnings that are in Appendix B of _The Latex Companion_ <<mittelbach2004>>, plus some more we encountered while error/warning hunting.
