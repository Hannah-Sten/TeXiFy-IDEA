 ...
 * @author Sten Wessel
 */
class CompilerEditor<C : LatexCompileStep, in S : SupportedCompiler<C>>(label: String, compilers: Iterable<S>) : LabeledComponent<ComboBox<CompilerComboBoxItem>>(), PanelWithAnchor {
