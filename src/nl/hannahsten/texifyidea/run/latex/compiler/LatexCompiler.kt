package nl.hannahsten.texifyidea.run.latex.compiler
...
sealed class LatexCompiler : Compiler<CompileLatexCompileStep> {
...
class CustomLatexCompiler(override val executablePath: String) : LatexCompiler(),
                                                                 CustomCompiler<CompileLatexCompileStep> {

    override fun getCommand(step: CompileLatexCompileStep) = listOf(executablePath)
}
...
abstract class SupportedLatexCompiler(
     ...
     *          The current project.
     */
    override fun getCommand(step: CompileLatexCompileStep): List<String>? {
