...
See link:Run-configurations#Run-configuration-settings[the Run configurations page] for more info.
...
* (MiKTeX only) Option to set a custom path for auxiliary files
* Option to set a custom path for output files
