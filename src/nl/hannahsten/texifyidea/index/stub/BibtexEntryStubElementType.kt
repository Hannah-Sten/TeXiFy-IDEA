...
open class BibtexEntryStubElementType(val debugName: String) : IStubElementType<BibtexEntryStub, BibtexEntry>("bibtex-entry", BibtexLanguage) {
    ...
    override fun getExternalId() = "texify.bibtex.entry"
