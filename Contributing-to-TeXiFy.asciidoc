...
e: Supertypes of the following classes cannot be resolved. Please make sure you have the required dependencies in the classpath:
    class nl.hannahsten.texifyidea.grammar.LatexLexer, unresolved supertypes: FlexLexer
----

then open LatexLexer.java, wait until IntelliJ finished its inspections, then run again.
