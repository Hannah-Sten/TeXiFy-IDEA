...
enum class LatexMathCommand(
    ...
    PROD("prod", display = "∏", collapse = true),
    ...
    INT("int", display = "∫", collapse = true),
    IINT("iint", dependency = AMSMATH, display = "∬", collapse = true),
    IIINT("iiint", dependency = AMSMATH, display = "∭", collapse = true),
    IIIINT("iiiint", dependency = AMSMATH, display = "⨌", collapse = true),
