...
import nl.hannahsten.texifyidea.run.legacy.pdfviewer.OpenCustomPdfViewerListener
...
import nl.hannahsten.texifyidea.run.legacy.pdfviewer.SumatraForwardSearchListener
import nl.hannahsten.texifyidea.run.legacy.pdfviewer.ViewerForwardSearch
...
open class LatexCommandLineState(environment: ExecutionEnvironment, private val runConfig: LatexRunConfiguration) : CommandLineState(environment) {
    ...
    private fun addOpenViewerListener(handler: ProcessHandler, focusAllowed: Boolean = true) {
        ...
        // Sumatra does not support DVI
            ...
            handler.addProcessListener(SumatraForwardSearchListener(runConfig))
        }
            ...
            ViewerForwardSearch(runConfig.pdfViewer ?: InternalPdfViewer.NONE).execute(handler, runConfig, focusAllowed)
        }
