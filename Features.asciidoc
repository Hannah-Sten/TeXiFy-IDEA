...
* link:Code-style-issues#en-dash[En dash in number ranges]
* link:Code-style-issues#dot[Use of `.` instead of `\cdot`]
* link:Code-style-issues#times[Use of `x` instead of `\times`]
* link:Code-style-issues#vertically-uncentered-colon[Vertically uncentered colon: use of raw `:=` instead of `\coloneqq` by mathtools (and variants)]
* link:Code-style-issues#grouped-superscript-and-subscript[Grouped superscript and subscript]
* link:Code-style-issues#qedhere[Insert `\qedhere` in trailing displaymath environment]
* link:Code-style-issues#dotless-i[Dotless versions of i and j must be used with diacritics]
* link:Code-style-issues#high-commands[Enclose high commands with `\leftX..\rightX`]
* link:Code-style-issues#citation-before-interpunction[Citations must be placed before interpunction]
...
===== Spacing
* link:Code-style-issues#non-escaped-common-math-operators[Non-escaped common math operators]
* link:Code-style-issues#non-breaking-spaces-before-references[Non-breaking spaces before references]
* link:Code-style-issues#ellipsis[Ellipsis with `...` instead of `\ldots` or `\dots`]
* link:Code-style-issues#normal-space-after-abbreviation[Normal space after abbreviation]
* link:Code-style-issues#end-of-sentence-space-after-capitals[End-of-sentence space after sentences ending with capitals]
* link:Code-style-issues#extreme-inequalities[Use the matching amssymb symbol for extreme inequalities]
